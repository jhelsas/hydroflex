...
100    format(7E15.5)
	...
	gzi(k)=0.d0
      ...
      write(*,*) dx(1), dx(2), dx(3),h, xmax(3),xmin(3)
	...
	write(3,100) gzi0(1),gzi0(2), gzi0(3), ft, fcal,w(j)
      end do
	end do
	end do
...
c     discard those which contributes less than 0.5%
	...
	implicit real*8(a-h, o-z)
      dimension gzi(ndim), dx(ndim), Xmax(ndim), Xmin(ndim)
